...
import {Breadcrumb, Button, Layout, Table, Space, PageHeader, Tag, Popconfirm, Image} from "antd";
import {Link} from 'react-router-dom';

const {Content} = Layout;
import reqwest from 'reqwest';
import {CheckCircleOutlined, CloseCircleOutlined} from "@ant-design/icons";
import shopDelete from "../../requests/Shops/ShopDelete";
    ...
    columns = [
        ...
        },
        {
            ...
            render: (delivery_type) => {
                return (<Tag color="#2db7f5">#{this.deliveryType[delivery_type]}</Tag>);
            },
        },
        {
            title: 'Delivery fee',
        ...
        },
        {
            ...
            render: (options, row) => {
                return (<div>
                    {
                        options.edit && isAllowed("/shops/edit") && (
                            <Button type="link">
                    ...
                    {
                        options.delete && isAllowed("/shops/delete") && row.default != 1 && (<Popconfirm
        ...
        return (
            <PageLayout>
                ...
                <PageHeader
                    ...
                    title="Shops"
                    subTitle="Create, remove and edit shops"
                    extra={[
                        isAllowed("/shops/add") && <Link to="/shops/add" key="orders" className="btn btn-success">
                            Add shop
                        </Link>
                    ]}
                >
