...
import mediasDelete from "../../requests/Medias/MediasDelete";
...
class Medias extends React.Component {
                ...
                return (<div>
                    ...
                    }
                    {
                        options.delete && row.default != 1 && (<Popconfirm
                            ...
                            onConfirm={() => this.handleOk(row.file)}
    ...
    handleOk = async (id) => {
        ...
        let data = await mediasDelete(id);
        ...
        return (
            <PageLayout>
                <Breadcrumb style={{margin: '16px 0'}}>
                    <Breadcrumb.Item>Medias</Breadcrumb.Item>
                </Breadcrumb>
                <PageHeader
