...
import bannerDelete from "../../requests/Banners/BannerDelete";
    ...
    columns = [
        ...
        },
        {
            ...
            render: (options, row) => {
                return (<div>
                    {
                        options.edit && isAllowed("/banners/edit") && (
                            <Button type="link">
                                <Link to={{
                                    pathname: "/banners/edit",
                    ...
                    {
                        options.delete && row.default != 1 && isAllowed("/banners/delete") && (<Popconfirm
        ...
        return (
            <PageLayout>
                ...
                <PageHeader
                    ...
                    title="Banners"
                    subTitle="Create, remove and edit banners"
                    extra={isAllowed("/banners/add") && [
                        <Link to="/banners/add" key="add" className="btn btn-success">
                            Add banner
                        </Link>
                    ]}
                >
