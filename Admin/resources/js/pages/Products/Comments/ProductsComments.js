...
import productCommentDelete from "../../../requests/ProductCommentDelete";
...
class ProductsComments extends React.Component {
    ...
    handleOk = async (id) => {
        ...
        let data = await productCommentDelete(id);
        ...
        return (
            <PageLayout>
                <Breadcrumb style={{margin: '16px 0'}}>
                    <Breadcrumb.Item>Products comments</Breadcrumb.Item>
                </Breadcrumb>
                <PageHeader
