...
import extrasGroupDelete from "../../../requests/ExtrasGroups/ExtrasGroupDelete";

class ExtrasGroup extends React.Component {
    columns = [
        {
            title: 'Name',
            dataIndex: 'name',
    ...
    handleOk = async (id) => {
        ...
        let data = await extrasGroupDelete(id);
    ...
    fetch = (params = {}) => {
        ...
        reqwest({
            url: '/api/auth/extra-group/datatable',
            method: 'post',
            type: 'json',
            headers: {
