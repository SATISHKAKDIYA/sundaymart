...
class Products extends React.Component {
        ...
        },
        {
            ...
            render: (options, row) => {
                return (<div>
                    ...
                    {
                        options.delete && isAllowed("/products/delete") && row.default != 1 && (<Popconfirm
    ...
    fetch = (params = {}) => {
        ...
        reqwest({
            url: '/api/auth/product/datatable',
            method: 'post',
            type: 'json',
            headers: {
        ...
        return (
            <PageLayout>
                ...
                <PageHeader
                    ...
                    title="Products"
                    subTitle="Create, remove and edit products"
                    extra={[
                        isAllowed("/products/add") && <Link to="/products/add" key="add" className="btn btn-success">
                            Add product
                        </Link>,
