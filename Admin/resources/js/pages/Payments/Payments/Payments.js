...
import paymentDelete from "../../../requests/Payments/PaymentsDelete";
...
class Payments extends React.Component {
    ...
    handleOk = async (id) => {
        ...
        let data = await paymentDelete(id);
    ...
    fetch = (params = {}) => {
        ...
        reqwest({
            url: '/api/auth/payments/datatable',
            method: 'post',
            type: 'json',
            headers: {
        ...
        return (
            <PageLayout>
                ...
                <PageHeader
                    ...
                    title="Payments"
                    subTitle="Create, remove and edit payments"
                    extra={[
                        <Link to="/payments/add" key="add" className="btn btn-success">
                            Add Payment
                        </Link>
                    ]}
                >
