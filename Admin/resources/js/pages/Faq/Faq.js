        ...
        },
        {
            ...
            render: (options, row) => {
                return (<div>
                    ...
                    {
                        options.delete && isAllowed("/faq/delete") && row.default != 1 && (<Popconfirm
        ...
        return (
            <PageLayout>
                ...
                <PageHeader
                    ...
                    subTitle="Create, remove and edit faq"
                    extra={isAllowed("/faq/add") && [
                        <Link to="/faq/add" key="add" className="btn btn-success">
                            Add faq
                        </Link>
                    ]}
                >
