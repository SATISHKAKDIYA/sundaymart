    ...
    columns = [
        ...
        },
        {
            ...
            render: (options, row) => {
                return (<div>
                    {
                        options.edit && isAllowed("/brands/edit") && (
                            <Button type="link">
                                <Link to={{
                    ...
                    {
                        options.delete && row.default != 1 && isAllowed("/brands/delete") && (<Popconfirm
        ...
        return (
            <PageLayout>
                ...
                <PageHeader
                    ...
                    title="Brands"
                    subTitle="Create, remove and edit brands"
                    extra={isAllowed("/brands/add") && [
                        <Link to="/brands/add" key="add" className="btn btn-success">
                            Add brand
                        </Link>
                    ]}
                >
