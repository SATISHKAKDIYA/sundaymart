        ...
        },
        {
            ...
            render: (options, row) => {
                return (<div>
                    ...
                    {
                        options.delete && isAllowed("/coupons/delete") && row.default != 1 && (<Popconfirm
        ...
        return (
            <PageLayout>
                ...
                <PageHeader
                    ...
                    title="Coupons"
                    subTitle="Create, remove and edit coupons"
                    extra={isAllowed("/coupons/add") && [
                        <Link to="/coupons/add" key="add" className="btn btn-success">
                            Add coupon
                        </Link>
                    ]}
                >
