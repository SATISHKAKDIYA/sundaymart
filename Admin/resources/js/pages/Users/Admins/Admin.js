    ...
    columns = [
        ...
        },
        {
            ...
            render: (options, row) => {
                return (<div>
                    {
                        options.edit && isAllowed("/admins/edit") && row.id_role != 1 && (
                            <Button type="link">
                                <Link to={{
                    ...
                    {
                        options.delete && isAllowed("/admins/delete") && row.id_role != 1 && (<Popconfirm
        ...
        return (
            <PageLayout>
                ...
                <PageHeader
                    ...
                    title="Admins"
                    subTitle="Create, remove and edit admins"
                    extra={[
                        isAllowed("/admins/add") && <Link to="/admins/add" key="add" className="btn btn-success">
                            Add admin
                        </Link>
                    ]}
                >
